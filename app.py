...
If the target language is English and the input is "我喜欢吃苹果", a correct output would be:
"我 {{like}} 吃 {{apples}}."
...
def main():
    ...
    # Language selection
    primary_language = st.selectbox("Select your primary language:", config['supported_languages'])
    target_language = st.selectbox("Select the target language your are learning:", [lang for lang in config['supported_languages'] if lang != primary_language])

    # Input method selection
    input_method = st.radio("Choose input method:", ["Custom Text", "Example Sentences"])
